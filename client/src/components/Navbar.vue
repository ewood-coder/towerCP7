...
<template>
	<nav class="navbar navbar-expand-sm px-3 bgColor text-light">
		...
		<button class="navbar-toggler text-light" type="button" data-bs-toggle="collapse" data-bs-target="#navbarText"
			aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
			<span class="navbar-toggler-icon text-light"></span>
		</button>
		<div class="collapse navbar-collapse text-light" id="navbarText">

			<div class="ms-0 ms-md-auto d-flex me-auto me-md-0 text-end text-light">
