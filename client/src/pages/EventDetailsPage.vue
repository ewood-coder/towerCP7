		...
		<section v-if="activeEvent" class="row">
			...
			<div class="col-12 col-md-6">
				...
				<div class="d-flex flex-column justify-content-end">
					<h4 v-if="!activeEvent.isCanceled" class="mt-3">{{ activeEvent.capacity - activeEvent.ticketCount }}
						spots left
					</h4>
					...
					<button
						:disabled="isAttending || activeEvent.isCanceled || activeEvent.ticketCount >= activeEvent.capacity"
